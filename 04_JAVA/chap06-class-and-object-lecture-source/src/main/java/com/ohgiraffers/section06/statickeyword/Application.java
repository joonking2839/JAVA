...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *  하지만 static 키워드의 남발은 유지보수와 추척이 힘든 코드를 작성하는 피해야할 방식이다.
        ...
        /* static 메소드도 이렇게 호출할 수는 있다.
         *  하지만 static 메소드의 경우에는 인스턴스를 생성하지 않고 호출하는 방식으로
         *  사용해야한다.
         *  static method는 정적 영역에 두고 인스턴스를 생성하지 않고 호출할 목적으로
         *  만들기 때문에 static 메소드를 호출하는 방식으로 사용해야한다.
         * */
