...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 지금까지 자바에서 제공되는 자료들을 취급하는 자료형에 대해 학습하다.
        ...
        /* 1. 변수명을 다 관리해야 하는 단점이 있다.
         *  2. 모든 회원 정보를 인자로 메소드 호출 시 값을 전달해야 하면 너무 많은 값들을 인자로 전달해야 해서
         *     한 눈에 안들어온다.
         *  3. 리턴은 1개의 값만 가능하기 때문에 회원정보를 묶어서 리턴값으로 사용할 수 없다. (서로 다른 자료형이기에)
         * */
         ...
         *  heap에 생성되기 때문이 jvm 기본값으로 초기화 된다.
         * */
