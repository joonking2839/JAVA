...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         *             인덱스는 0부터 시작하는 숫자 체계이며, 벗어난 정수를 인자로 전달하는 경우는
        ...
        /* compareTo() : 인자로 전달한 문자열과 사전 순으로 비교를 하여
        ...
        System.out.println(str2.compareTo(str4));   // j : 106 J : 74
        System.out.println(str4.compareTo(str2));
        System.out.println(str2.compareTo(str5));   // j : 106 o : 111
        ...
        System.out.println("#" + trimStr + "#");        // 원본에 영향을 주지 않는다.
        ...
        /* replace() : 문자열에서 대체할 문자열로 기존 문자열로 변경해서 반환한다.
         *              원본에 영향을 주지 않는다.
         * */
        System.out.println(javaOracle.replace("java", "python"));
        System.out.println(javaOracle);

        /* length() : 문자열의 길이를 정수형 반환한다.
         * */
