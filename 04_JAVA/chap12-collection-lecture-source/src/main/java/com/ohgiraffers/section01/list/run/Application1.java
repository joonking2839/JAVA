...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         *
         *
         *  컬렉션 프레임워크는 크게 3가지 인터페이스 중 한 가지를 상속받아 구현해 놓았다.
         *  1. List 인터페이스
         *  2. Set 인터페이스
         *  3. Map 인터페이스
         *
...
//        Collection clist = new ArrayList();
        ...
        for(int i = 0; i < alist.size(); i++) {
            // 인덱스에 해당하는 값을 가져올 때는 get() 를 사용한다.
        ...
        // 저장된 값을 삭제할 때는 remove() 사용한다.
        alist.remove(2);
        System.out.println(alist);

        // 지정된 위치의 값을 수정할 때에도 인덱스를 활용할 수 있고 set() 사용한다.
        ...
        // 역순 정렬 기능은 LinkedList에 정의되어 있는데,
        // 현재 사용하는 ArrayList를 LinkedList로 변경하였다.
