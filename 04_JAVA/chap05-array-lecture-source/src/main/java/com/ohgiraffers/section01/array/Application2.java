...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 배열의 할당할 때는 반드시 배열의 크기를 지정해 주어야 한다. */
//        iarr = new int[];
        iarr = new int[5];
        carr = new char[10];
         ...
         * */
        System.out.println(iarr2);      // 16 진수 주소값 출력
        System.out.println(carr2);

        /* hashCode() : 일반적으로 객체의 주소값을 10진수로 변환해서 생성한 객체의 공유한 정수값을 반환한다.
        ...
        /* NullPointerException : 이무것도 참조하지 않고 null이라는 특수한 값을 참조하고 있는 경우,
         *                         참조연산자를 사용하게 될 때 발생하는 에러 */
//        System.out.println(darr.length);
    }
}